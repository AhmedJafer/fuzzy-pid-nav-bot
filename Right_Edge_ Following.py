...
front_sensor = [[(0.60,1),(0.65,0)],[(0.60,0),(0.65,1),(0.7,0)],[(0.65,0),(0.7,1)]]
back_sensor= [[(0.60,1),(0.65,0)],[(0.60,0),(0.65,1),(0.7,0)],[(0.65,0),(0.7,1)]]

LMS = {"slow":0.05,"medium":0.1,"fast":0.15}
RMS = {"right":-0.2,"front":0.0,"left":0.2}
Fz=Fuzzy_system(front_sensor,back_sensor,LMS,RMS)
...
def movement():
    ...
    print("Min distance in front region: ", regions_['fright'],regions_['fback'])

    #create an object of twist class, used to express the linear and angular velocity of the turtlebot
    msg = Twist()
    msg.linear.x,msg.angular.z = Fz.fuzzification(regions_['fright'],regions_['fback'])
